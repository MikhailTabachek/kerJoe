...
from myapp.models import User, JokePost
...
def user_posts(username):
    ...
    joke_posts = JokePost.query.filter_by(author=user).order_by(JokePost.date.desc()).paginate(page=page, per_page=5) 
    return render_template('user_joke_posts.html', joke_posts=joke_posts, user=user)
